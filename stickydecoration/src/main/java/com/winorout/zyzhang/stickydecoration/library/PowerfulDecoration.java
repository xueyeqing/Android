package com.winorout.zyzhang.stickydecoration.library;
 ...
 * @Date: 17/7/9 上午9:31
 */
public class PowerfulDecoration extends BaseDecoration {

    private PowerGroupListener mGroupListener;
    private Paint mGroutPaint;

    private PowerfulDecoration(PowerGroupListener groupListener) {
        super();
    ...
    public static class Builder {
        PowerfulDecoration mDecoration;

        private Builder(PowerGroupListener listener) {
            mDecoration = new PowerfulDecoration(listener);
        }
        ...
        public PowerfulDecoration build() {
            return mDecoration;
        }
